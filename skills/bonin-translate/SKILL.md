...
metadata:
  openclaw:
    homepage: https://github.com/BoninEDU/bonin-skills#bonin-translate
    requires:
      anyBins:
        - bun
        - npx
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.bonin-skills/bonin-translate/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/bonin-skills/bonin-translate/EXTEND.md` | XDG |
| 3 | `$HOME/.bonin-skills/bonin-translate/EXTEND.md` | User home |
