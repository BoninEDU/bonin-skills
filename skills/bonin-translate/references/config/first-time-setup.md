...
description: First-time setup flow for bonin-translate preferences
---
...
options:
  - label: "User (Recommended)"
    description: "$HOME/.bonin-skills/ (all projects)"
  - label: "Project"
...
| Choice | Path | Scope |
|--------|------|-------|
| User | `$HOME/.bonin-skills/bonin-translate/EXTEND.md` | All projects |
| Project | `.bonin-skills/bonin-translate/EXTEND.md` | Current project |
