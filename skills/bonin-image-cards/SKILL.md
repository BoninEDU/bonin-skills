...
metadata:
  openclaw:
    homepage: https://github.com/BoninEDU/bonin-skills#bonin-image-cards
---
...
- **Reconfigure interactively** — delete EXTEND.md (or ask "reconfigure bonin-image-cards preferences" / "重新配置"). The next run re-triggers first-time setup.
