...
description: First-time setup flow for bonin-danger-x-to-markdown preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| User | `~/.bonin-skills/bonin-danger-x-to-markdown/EXTEND.md` | All projects |
| Project | `.bonin-skills/bonin-danger-x-to-markdown/EXTEND.md` | Current project |
