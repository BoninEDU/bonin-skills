---
name: bonin-danger-x-to-markdown
...
metadata:
  openclaw:
    homepage: https://github.com/BoninEDU/bonin-skills#bonin-danger-x-to-markdown
    requires:
      anyBins:
        - bun
        - npx
...
```bash
# macOS
cat ~/Library/Application\ Support/bonin-skills/x-to-markdown/consent.json

# Linux
cat ~/.local/share/bonin-skills/x-to-markdown/consent.json
```
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.bonin-skills/bonin-danger-x-to-markdown/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/bonin-skills/bonin-danger-x-to-markdown/EXTEND.md` | XDG |
| 3 | `$HOME/.bonin-skills/bonin-danger-x-to-markdown/EXTEND.md` | User home |
