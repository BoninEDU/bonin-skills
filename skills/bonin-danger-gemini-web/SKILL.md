...
metadata:
  openclaw:
    homepage: https://github.com/BoninEDU/bonin-skills#bonin-danger-gemini-web
    requires:
      anyBins:
        - bun
        - npx
...
- macOS: `~/Library/Application Support/bonin-skills/gemini-web/consent.json`
- Linux: `~/.local/share/bonin-skills/gemini-web/consent.json`
- Windows: `%APPDATA%\bonin-skills\gemini-web\consent.json`
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.bonin-skills/bonin-danger-gemini-web/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/bonin-skills/bonin-danger-gemini-web/EXTEND.md` | XDG |
| 3 | `$HOME/.bonin-skills/bonin-danger-gemini-web/EXTEND.md` | User home |
