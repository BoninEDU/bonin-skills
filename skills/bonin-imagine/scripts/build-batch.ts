...
Options:
  ...
  --provider <name>    Provider for bonin-imagine batch tasks (default: replicate)
  --model <id>         Explicit model for bonin-imagine batch tasks (default: resolved by bonin-imagine config/env)
