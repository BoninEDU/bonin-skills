---
name: bonin-markdown-to-html
description: Converts Markdown to styled HTML with WeChat-compatible themes. Supports code highlighting, math, PlantUML, footnotes, alerts, infographics, and optional bottom citations for external links. Use when user asks for "markdown to html", "convert md to html", "md 转 html", "微信外链转底部引用", or needs styled HTML output from markdown.
version: 1.56.1
metadata:
  openclaw:
    homepage: https://github.com/BoninEDU/bonin-skills#bonin-markdown-to-html
    requires:
      anyBins:
        - bun
        - npx
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.bonin-skills/bonin-markdown-to-html/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/bonin-skills/bonin-markdown-to-html/EXTEND.md` | XDG |
| 3 | `$HOME/.bonin-skills/bonin-markdown-to-html/EXTEND.md` | User home |
...
If CJK content detected AND `bonin-format-markdown` skill is available:
...
**If user agrees**: Invoke `bonin-format-markdown` skill to format the file, then use formatted file as input.
...
3. `bonin-post-to-wechat` EXTEND.md `default_theme` (cross-skill fallback)
...
Read `$HOME/.bonin-skills/bonin-post-to-wechat/EXTEND.md` if it exists and look for a `default_theme:` line. Use the value if present; otherwise fall through.
