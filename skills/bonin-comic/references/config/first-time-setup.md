...
description: First-time setup flow for bonin-comic preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.bonin-skills/bonin-comic/EXTEND.md` | Current project |
| User | `~/.bonin-skills/bonin-comic/EXTEND.md` | All projects |
