...
test -f .bonin-skills/bonin-comic/EXTEND.md && echo "project"
test -f "${XDG_CONFIG_HOME:-$HOME/.config}/bonin-skills/bonin-comic/EXTEND.md" && echo "xdg"
test -f "$HOME/.bonin-skills/bonin-comic/EXTEND.md" && echo "user"
```

```powershell
# PowerShell (Windows)
if (Test-Path .bonin-skills/bonin-comic/EXTEND.md) { "project" }
$xdg = if ($env:XDG_CONFIG_HOME) { $env:XDG_CONFIG_HOME } else { "$HOME/.config" }
if (Test-Path "$xdg/bonin-skills/bonin-comic/EXTEND.md") { "xdg" }
if (Test-Path "$HOME/.bonin-skills/bonin-comic/EXTEND.md") { "user" }
```

| Path | Location |
|------|----------|
| `.bonin-skills/bonin-comic/EXTEND.md` | Project directory |
| `$HOME/.bonin-skills/bonin-comic/EXTEND.md` | User home |
...
**Strategy A: Using `--ref` parameter** (e.g., bonin-image-gen)
