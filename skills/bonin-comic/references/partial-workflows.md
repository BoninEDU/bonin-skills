...
```bash
/bonin-comic content.md --storyboard-only
```
...
```bash
/bonin-comic content.md --prompts-only
```
...
```bash
/bonin-comic comic/topic-slug/ --images-only
```
...
```bash
# Single page
/bonin-comic comic/topic-slug/ --regenerate 3

# Multiple pages
/bonin-comic comic/topic-slug/ --regenerate 2,5,8

# Cover page
/bonin-comic comic/topic-slug/ --regenerate 0
```
