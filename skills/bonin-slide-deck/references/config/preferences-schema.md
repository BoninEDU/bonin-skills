...
Structure for user preferences in `.bonin-skills/bonin-slide-deck/EXTEND.md`.
...
Then use with: `/bonin-slide-deck content.md --style style-name`
...
1. `.bonin-skills/bonin-slide-deck/EXTEND.md` (project)
2. `$HOME/.bonin-skills/bonin-slide-deck/EXTEND.md` (user)
