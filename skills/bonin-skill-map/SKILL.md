...
| 类别 | 图标 | 含义 | 典型成员 |
|------|------|------|----------|
| 认知原子 | ◆ | 内容处理的原子操作 | bonin-plain, bonin-word, bonin-writes, bonin-paper |
| 输出铸造 | ▲ | 将内容转化为可交付物 | bonin-card |
| 联网触达 | ● | 与外部世界交互 | agent-reach |
| 系统运维 | ■ | Agent 自身的维护和管理 | datetime-check, memory-review, save-conversation, skill-creator, bonin-skill-map |
...
║  ◆ 认知原子                                              ║
║  +-----------------+----------------------------------+  ║
║  | bonin-plain v4.0  | 白 — 好问题+类比让人 grok        |  ║
║  | bonin-word  v1.0  | 英文单词深度拆解                  |  ║
║  | bonin-writes v4.0 | 写作引擎                          |  ║
║  | bonin-paper v2.0  | 论文阅读与分析                    |  ║
║  +-----------------+----------------------------------+  ║
║                                                          ║
║  ▲ 输出铸造                                              ║
║  +-----------------+----------------------------------+  ║
║  | bonin-card  v1.5  | 铸 — 内容转 PNG 可视化           |  ║
║  +-----------------+----------------------------------+  ║
║                                                          ║
║  ...                                                     ║
╚══════════════════════════════════════════════════════════╝
