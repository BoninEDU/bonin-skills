...
metadata:
  openclaw:
    homepage: https://github.com/BoninEDU/bonin-skills#bonin-compress-image
    requires:
      anyBins:
        - bun
        - npx
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.bonin-skills/bonin-compress-image/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/bonin-skills/bonin-compress-image/EXTEND.md` | XDG |
| 3 | `$HOME/.bonin-skills/bonin-compress-image/EXTEND.md` | User home |
