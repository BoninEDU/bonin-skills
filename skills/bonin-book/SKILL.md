...
掌握不掌握就看这步。在图上挪到一个作者没去过的位置——最好挨着 Bonin 自己的世界——用作者的框预测：站这个新位置上，他会说什么？预测完回头对账。猜对了，图就是你的了。
