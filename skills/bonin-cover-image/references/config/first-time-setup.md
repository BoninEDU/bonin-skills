...
description: First-time setup flow for bonin-cover-image preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.bonin-skills/bonin-cover-image/EXTEND.md` | Current project |
| User | `~/.bonin-skills/bonin-cover-image/EXTEND.md` | All projects |
