...
description: First-time setup flow for bonin-article-illustrator preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.bonin-skills/bonin-article-illustrator/EXTEND.md` | Current project |
| User | `~/.bonin-skills/bonin-article-illustrator/EXTEND.md` | All projects |
