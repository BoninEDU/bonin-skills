...
test -f .bonin-skills/bonin-article-illustrator/EXTEND.md && echo "project"
test -f "${XDG_CONFIG_HOME:-$HOME/.config}/bonin-skills/bonin-article-illustrator/EXTEND.md" && echo "xdg"
test -f "$HOME/.bonin-skills/bonin-article-illustrator/EXTEND.md" && echo "user"
```

```powershell
# PowerShell (Windows)
if (Test-Path .bonin-skills/bonin-article-illustrator/EXTEND.md) { "project" }
$xdg = if ($env:XDG_CONFIG_HOME) { $env:XDG_CONFIG_HOME } else { "$HOME/.config" }
if (Test-Path "$xdg/bonin-skills/bonin-article-illustrator/EXTEND.md") { "xdg" }
if (Test-Path "$HOME/.bonin-skills/bonin-article-illustrator/EXTEND.md") { "user" }
```
...
|------------------------|--------|
| Yes (e.g., bonin-image-gen with Google) | Pass reference images via `--ref` |
