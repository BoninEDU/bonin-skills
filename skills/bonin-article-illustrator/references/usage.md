...
# Specify type
/bonin-article-illustrator path/to/article.md --type infographic

# Specify style
/bonin-article-illustrator path/to/article.md --style blueprint

# Combine type and style
/bonin-article-illustrator path/to/article.md --type flowchart --style notion

# Specify density
/bonin-article-illustrator path/to/article.md --density rich

# Generate up to 4 images in parallel after prompts are saved
/bonin-article-illustrator path/to/article.md --batch-size 4
...
```bash
/bonin-article-illustrator api-design.md --type infographic --style blueprint
```

**Same thing with preset**:
```bash
/bonin-article-illustrator api-design.md --preset tech-explainer
```

**Personal story**:
```bash
/bonin-article-illustrator journey.md --preset storytelling
```

**Tutorial with steps**:
```bash
/bonin-article-illustrator how-to-deploy.md --preset tutorial --density rich
```

**Opinion article with poster style**:
```bash
/bonin-article-illustrator opinion.md --preset opinion-piece
```

**Preset with override**:
```bash
/bonin-article-illustrator article.md --preset tech-explainer --style notion
```
