---
name: bonin-article-illustrator
...
metadata:
  openclaw:
    homepage: https://github.com/BoninEDU/bonin-skills#bonin-article-illustrator
---
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.bonin-skills/bonin-article-illustrator/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/bonin-skills/bonin-article-illustrator/EXTEND.md` | XDG |
| 3 | `$HOME/.bonin-skills/bonin-article-illustrator/EXTEND.md` | User home |
...
- **Reconfigure interactively** — delete EXTEND.md (or ask "reconfigure bonin-article-illustrator preferences" / "重新配置"). The next run re-triggers first-time setup.
