...
- Typically 5–10× slower than direct OpenAI / Google API calls (except on cache hits). Tune via `BONIN_CODEX_IMAGEGEN_TIMEOUT_MS`, `BONIN_CODEX_IMAGEGEN_RETRIES`, and `BONIN_CODEX_IMAGEGEN_CACHE_DIR`.
