...
metadata:
  openclaw:
    homepage: https://github.com/BoninEDU/bonin-skills#bonin-wechat-summary
    requires:
      anyBins:
        - wx
---
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.bonin-skills/bonin-wechat-summary/EXTEND.md` (relative to project root) | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/bonin-skills/bonin-wechat-summary/EXTEND.md` | XDG |
| 3 | `$HOME/.bonin-skills/bonin-wechat-summary/EXTEND.md` | User home |
