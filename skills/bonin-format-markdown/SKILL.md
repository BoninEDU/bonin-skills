...
metadata:
  openclaw:
    homepage: https://github.com/BoninEDU/bonin-skills#bonin-format-markdown
    requires:
      anyBins:
        - bun
        - npx
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.bonin-skills/bonin-format-markdown/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/bonin-skills/bonin-format-markdown/EXTEND.md` | XDG |
| 3 | `$HOME/.bonin-skills/bonin-format-markdown/EXTEND.md` | User home |
