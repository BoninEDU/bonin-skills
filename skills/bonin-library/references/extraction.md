...
- **墨像（可选）** = `<image href="file:///…/assets/bonin-portrait.png">` 嵌入的继刚墨像，约 200×200，立在左侧（视线朝右、望进图里）。**仅当画面含「你」时使用**——像素级一致、一眼是他，比手绘小人鲜明得多。
...
<svg viewBox="0 0 860 400" xmlns="http://www.w3.org/2000/svg">
      ...
      <image href="file:///Users/BoninEDU/.claude/skills/bonin-library/assets/bonin-portrait.png" x="14" y="128" width="208" height="209"/>
