...
metadata:
  openclaw:
    homepage: https://github.com/BoninEDU/bonin-skills#bonin-post-to-wechat
    requires:
      anyBins:
        - bun
        - npx
...
| Path | Scope |
|------|-------|
| `.bonin-skills/bonin-post-to-wechat/EXTEND.md` | Project |
| `${XDG_CONFIG_HOME:-$HOME/.config}/bonin-skills/bonin-post-to-wechat/EXTEND.md` | XDG |
| `$HOME/.bonin-skills/bonin-post-to-wechat/EXTEND.md` | User home |
...
| Profile dir | Shared profile at `bonin-skills/chrome-profile` |
...
| API credentials | Follow guided setup in Step 2, or set in `.bonin-skills/.env` |
...
**API selected + missing credentials** → run guided setup per `references/api-setup.md` (writes to `.bonin-skills/.env`).
