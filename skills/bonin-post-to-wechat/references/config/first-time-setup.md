...
description: First-time setup flow for bonin-post-to-wechat preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.bonin-skills/bonin-post-to-wechat/EXTEND.md` | Current project |
| User | `~/.bonin-skills/bonin-post-to-wechat/EXTEND.md` | All projects |
