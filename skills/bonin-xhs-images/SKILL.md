...
| Path | Scope |
|------|-------|
| `.bonin-skills/bonin-image-cards/EXTEND.md` | Project |
| `${XDG_CONFIG_HOME:-$HOME/.config}/bonin-skills/bonin-image-cards/EXTEND.md` | XDG |
| `$HOME/.bonin-skills/bonin-image-cards/EXTEND.md` | User home |
