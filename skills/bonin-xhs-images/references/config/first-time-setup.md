...
description: First-time setup flow for bonin-xhs-images preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.bonin-skills/bonin-xhs-images/EXTEND.md` | Current project |
| User | `~/.bonin-skills/bonin-xhs-images/EXTEND.md` | All projects |
