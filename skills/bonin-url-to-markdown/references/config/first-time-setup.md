...
description: First-time setup flow for bonin-url-to-markdown preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| User | `~/.bonin-skills/bonin-url-to-markdown/EXTEND.md` | All projects |
| Project | `.bonin-skills/bonin-url-to-markdown/EXTEND.md` | Current project |
