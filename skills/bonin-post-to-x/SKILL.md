...
metadata:
  openclaw:
    homepage: https://github.com/BoninEDU/bonin-skills#bonin-post-to-x
    requires:
      anyBins:
        - bun
        - npx
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.bonin-skills/bonin-post-to-x/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/bonin-skills/bonin-post-to-x/EXTEND.md` | XDG |
| 3 | `$HOME/.bonin-skills/bonin-post-to-x/EXTEND.md` | User home |
...
| Profile dir | Shared profile at `bonin-skills/chrome-profile` (see CLAUDE.md Chrome Profile section) |
