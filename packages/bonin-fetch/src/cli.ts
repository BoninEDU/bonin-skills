...
bonin-fetch - Read a URL into Markdown or JSON with Chrome CDP
...
Examples:
  ...
  bonin-fetch https://example.com --format json --output article.json
  bonin-fetch https://x.com/lennysan/status/2036483059407810640 --wait-for interaction
  bonin-fetch https://x.com/lennysan/status/2036483059407810640 --wait-for force
`.trim();
