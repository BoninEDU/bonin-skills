...
`bonin-fetch` 是一个基于 Chrome CDP 的 Bun CLI。输入 URL，它会输出高质量
...
- 提供登录/验证场景下的交互等待模式
- Chrome profile 默认对齐 `bonin-skills/chrome-profile`
...
Options:
  ...
  --chrome-profile-dir <path>
                        指定 Chrome profile 目录。默认使用 bonin_CHROME_PROFILE_DIR，
                        否则回退到 bonin-skills/chrome-profile
