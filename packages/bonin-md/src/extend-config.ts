...
export function loadExtendConfig(): Partial<ExtendConfig> {
  const paths = [
    path.join(process.cwd(), ".bonin-skills", "bonin-markdown-to-html", "EXTEND.md"),
    path.join(
      process.env.XDG_CONFIG_HOME || path.join(homedir(), ".config"),
      "bonin-skills", "bonin-markdown-to-html", "EXTEND.md"
    ),
    path.join(homedir(), ".bonin-skills", "bonin-markdown-to-html", "EXTEND.md"),
  ];
